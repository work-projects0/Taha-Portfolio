          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div data-aos={aosType}>
              <div className={card}>
                ...
                <h4 className="font-bold mb-2"> {t("cards.card1.title")}</h4>
            ...
            <div data-aos={aosType2}>
              ...
              <div className={card}>
                ...
                <h4 className="font-bold mb-2">{t("cards.card2.title")}</h4>
            ...
            <div data-aos={aosType}>
              <div className={card}>
                ...
                <h4 className="font-bold mb-2"> {t("cards.card3.title")}</h4>
